    ...
    return (
        <div>
            ...
            <div className='relative z-[10]'>
                <div className=" flex flex-col gap-10 bg-primary h-[300px] mt-[350px] mb-[100px] rounded-lg relative z-[2] shadow-[0_0_15px_5px_rgba(255,255,255,0.5)] justify-center items-center ">
                    <h2 className='text-[40px] font-bold text-white text-center '>LOS ESPERO ESTE DOMINGO VENGAN TODOS</h2>
